...
export default function Home() {
  return (
    <div className="text-white bg-gray-950 min-h-screen bg-cover bg-center">
      ...
      <div className="flex justify-center items-center flex-col gap-8 mt-16 mb-8">
        <div className="text-center text-4xl lg:w-3/5 font-light">
          Ficou alguma dúvida?
        </div>
        <div className="text-center text-2xl text-white/75 lg:w-3/5">
        ...
        <a
          ...
          className="bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-8 rounded-lg text-xl flex items-center gap-3 transition-colors duration-200"
        >
          <svg
            width="24"
            height="24"
